...
import { Lock, Unlock, Lightbulb, ArrowRight, Heart, BookOpen, Gamepad2, PenTool, Play, Pause, RotateCcw, Sparkles, Gift } from 'lucide-react';
...
const CreativeCorner = () => {
  ...
  const [gameElements, setGameElements] = useState([
    ...
    { id: 'laughter', emoji: '😊', name: 'Laughter', placed: false, x: 0, y: 0 },
...
Your Brother Ujjwal❤️`;
    ...
    if (isTyping) {
      ...
      const timer = setInterval(() => {
        if (index < personalMessage.length) {
          setTypedText(personalMessage.slice(0, index + 1));
          index++;
        } else {
          setIsTyping(false);
          clearInterval(timer);
  ...
  const handleSubmit = () => {
    if (answer.toLowerCase().includes('shinta') && answer.toLowerCase().includes("ma'am")) {
      setIsUnlocked(true);
      setShowError(false);
    } else {
      setShowError(true);
  ...
  const handleDrop = (e) => {
    ...
    setGameElements(prev => 
      prev.map(el => 
        el.id === elementId 
          ? { ...el, placed: true, x: x - 25, y: y - 25 }
          : el
      )
    );

    const allPlaced = gameElements.every(el => el.id === elementId ? true : el.placed);
    if (allPlaced) {
  ...
  const debateTopics = [
    {
      ...
      description: "Has technology brought us closer or driven us apart? A classic debate that you'd probably have strong opinions about!"
    },
    {
      topic: "Education System Reform",
      description: "Should the education system focus more on creativity or standardized learning? Perfect for your analytical mind!"
    },
    {
      topic: "Social Media: Boon or Bane",
      description: "Does social media empower voices or create echo chambers? A contemporary debate for the modern thinker!"
    },
    {
      topic: "Climate Change Solutions",
      description: "Individual responsibility vs. corporate accountability - where should the focus be?"
    }
  ];
      ...
      <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
        <div className="max-w-md mx-auto">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-4">Protected Section</h2>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-white">A Personal Message</h2>
              <button
            ...
            <div className="text-white/90 text-lg leading-relaxed font-mono min-h-96 whitespace-pre-line">
              {typedText}
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-white/20 to-white/5 p-8 mb-6 min-h-80">
              <h3 className="text-xl font-bold text-white mb-4">{scrapbookPages[currentPage].title}</h3>
            ...
            <div className="flex justify-between items-center">
              ...
              <button
                onClick={() => setCurrentPage(prev => Math.min(scrapbookPages.length - 1, prev + 1))}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-bold text-white mb-4">Elements to Use:</h3>
                <div className="grid grid-cols-2 gap-4">
                  {gameElements.filter(el => !el.placed).map(element => (
                    <div
                      key={element.id}
                      draggable
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-4">Bond Canvas:</h3>
                <div
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            {!currentPoem && (
              <div className="text-center text-white/70 py-12">
                ...
                <p className="text-lg">Click the button above to generate your first personalized poem!</p>
              </div>
            )}
          </div>
        </div>
    ...
    <div className="min-h-screen py-20 px-4 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/80">For my brilliant debater sister!</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2">Personal Message</h3>
            <p className="text-white/90">A heartfelt letter written just for you with a beautiful typing animation</p>
          </button>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2">Digital Scrapbook</h3>
            <p className="text-white/90">Flip through pages of poems and feelings I've written about our bond</p>
          </button>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2">Build-a-Bond Game</h3>
            <p className="text-white/90">A fun mini-game where you build our sibling bond piece by piece</p>
          </button>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2">Poem Generator</h3>
            <p className="text-white/90">Generate endless personalized poems with my pre-written verses</p>
          </button>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 mb-8">
          ...
          <p className="text-white/90 text-lg leading-relaxed">
            I know how much you love debates and intellectual discussions! Here's a collection of 
            thought-provoking topics just for you. Each one is carefully chosen knowing your 
            brilliant mind and passion for meaningful conversations.
          </p>
        </div>
